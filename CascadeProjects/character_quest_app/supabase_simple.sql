-- Simple database setup - run all in one go
-- This creates only essential tables needed for the app to work

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Characters table (minimal version)
...
-- Daily stats table (essential for dashboard)
...
-- Game events table (essential for dashboard)
...
-- Subscriptions table (essential for dashboard) 
